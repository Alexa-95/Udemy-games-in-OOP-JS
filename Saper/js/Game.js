...
class Game extends UI{
  // hash strawia że metoda jest prywatna
  #config = {
    easy:{
      rows: 8,
      cols: 8,
  ...
  #buttons = {
    ...
    #newGame(
      ...
      this.#cellToReveal = this.#numberOfCols * this.#numberOfRows - this.#numberOfMines;
  ...
  initializeGame(){
    ...
    this.#modal.infoText = this.#timer.numberOfSecounds < this.#timer.maxNumberOfSecounds ? 
    `You won! It took you ${this.#timer.numberOfSecounds} seconds.` :
    'You won! Contragulation'
  ...
  #handleNewGameClick(
    ...
    this.#removeCellsEventsListeners();
  ...
  #clickCell(cell){ 
    ...
    if(this.#revealedCells === this.#cellToReveal && !this.#isGameFinished){
      this.#endGame(true);
    }
  }
