...
import { DIAMOND_SIZE, EMPTY_BLOCK, gameLevels, GAME_BOARD_X_OFFSET, GAME_BOARD_Y_OFFSET } from './GameLevels.esm.js'
...
class Game extends Common {
  ...
  clearMatched(){
    ...
    this.gameState.getGameBoard((_, idx, diamonds) => {
  ...
  checkEndOfGame() {
	  if(!this.gameState.getLeftMovement() && !this.gameState.getIsMoving()
	  && !this.gameState.getIsSwaping()){
		  ...
		  console.log('Jeżeli gram ma więcej punktów aktualizacja hight scores');
